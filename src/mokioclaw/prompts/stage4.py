"""Stage4 context compressor prompt.

Used by context_compressor_node to compress the full message history
into a structured JSON summary that fits within the token budget.
"""
